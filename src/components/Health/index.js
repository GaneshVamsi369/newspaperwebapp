...
class Health extends Component{
    ...
    getlist=async ()=>{
        ...
        const response=await fetch('https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=07deafef12c44217baa04953445a1156')
        if(response.ok){
                ...
                {value=>{
                    ...
                    return(
                        <div className={`${bg}`}>
                            ...
                            <h1 className={`${text} ${bgg} ${shadow} title`}>Health</h1>
